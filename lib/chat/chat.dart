...
import 'package:seeker/animation/const.dart';
import 'package:seeker/chat/fullPhoto.dart';
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(
          'Share here ',
          style: TextStyle(color: primaryColor, fontWeight: FontWeight.bold, fontFamily: "Roboto" ),
        ),
        centerTitle: true,
      ),
      body: new ChatScreen(
